...
princp = []
try:
    prox = requests.get('https://github.com/MATAL-BREND/JR.1/blob/main/JR.1.txt').text
...
def uaku():
    try:
        ...
        a = requests.get('https://github.com/MATAL-BREND/JR.1/blob/main/JR.1.txt').text
        ua = open('bbnew.txt', 'w')
...
\33[38;5;196m┗━""")          . Power BY TAMAK PATa
